...
const __jsVmSeed = "JSTKSEED2-f3e6e2b6dd1e75a6-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz_~!$@*().012345678.012345";
const __jsVmBinUrl = new URL("./jquery.bin?v=f3e6e2b6dd1e75a6", import.meta.url);
const __jsVmSourceMapUrl = new URL("./jquery.bin.map?v=f3e6e2b6dd1e75a6", import.meta.url);
